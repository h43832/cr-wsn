...
public class WSNNodesManager extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jButton8.setText(bundle.getString("WSNNodesManager.jButton8.text")); 
    ...
    jLabel47.setText(bundle.getString("WSNNodesManager.jLabel47.text")); 
    jPanel7.add(jLabel47);
    jLabel47.setBounds(20, 60, 90, 20);

    jTextField14.setFont(new java.awt.Font("?s?????", 0, 18)); 
    jTextField14.setText(bundle.getString("WSNNodesManager.jTextField14.text")); 
    jTextField14.setToolTipText(bundle.getString("WSNNodesManager.jTextField14.toolTipText")); 
    jPanel7.add(jTextField14);
    jTextField14.setBounds(110, 60, 60, 20);

    jLabel48.setFont(new java.awt.Font("?s?????", 0, 18)); 
    jLabel48.setText(bundle.getString("WSNNodesManager.jLabel48.text")); 
    ...
    jButton7.setText(bundle.getString("WSNNodesManager.jButton7.text")); 
    ...
    jTabbedPane1.addTab(bundle.getString("WSNNodesManager.jPanel1.TabConstraints.tabTitle"), jPanel1); 
    ...
    jLabel34.setText(bundle.getString("WSNNodesManager.jLabel34.text")); 
    ...
    jLabel35.setText(bundle.getString("WSNNodesManager.jLabel35.text")); 
    ...
    jLabel36.setText(bundle.getString("WSNNodesManager.jLabel36.text")); 
    ...
    jLabel37.setText(bundle.getString("WSNNodesManager.jLabel37.text")); 
    ...
    jButton9.setText(bundle.getString("WSNNodesManager.jButton9.text")); 
    ...
    jLabel45.setText(bundle.getString("WSNNodesManager.jLabel45.text")); 
    jLabel45.setOpaque(true);
    jPanel9.add(jLabel45);
    jLabel45.setBounds(40, 170, 320, 30);

    jLabel49.setFont(new java.awt.Font("?s?????", 0, 18)); 
    jLabel49.setText(bundle.getString("WSNNodesManager.jLabel49.text")); 
    jPanel9.add(jLabel49);
    jLabel49.setBounds(80, 120, 180, 23);

    jTextField15.setFont(new java.awt.Font("?s?????", 0, 18)); 
    jTextField15.setText(bundle.getString("WSNNodesManager.jTextField15.text")); 
    jPanel9.add(jTextField15);
    jTextField15.setBounds(270, 120, 100, 30);

    jTabbedPane2.addTab(bundle.getString("WSNNodesManager.jPanel9.TabConstraints.tabTitle"), jPanel9); 

    jPanel11.setLayout(null);

    jButton10.setFont(new java.awt.Font("?s?????", 0, 24)); 
    jButton10.setText(bundle.getString("WSNNodesManager.jButton10.text")); 
    ...
    jLabel38.setText(bundle.getString("WSNNodesManager.jLabel38.text")); 
    jPanel11.add(jLabel38);
    jLabel38.setBounds(50, 30, 400, 20);

    jTextField6.setFont(new java.awt.Font("?s?????", 0, 18)); 
    jTextField6.setText(bundle.getString("WSNNodesManager.jTextField6.text")); 
    ...
    jRadioButton5.setText(bundle.getString("WSNNodesManager.jRadioButton5.text")); 
    jPanel11.add(jRadioButton5);
    jRadioButton5.setBounds(210, 370, 110, 30);

    buttonGroup3.add(jRadioButton6);
    jRadioButton6.setFont(new java.awt.Font("?s?????", 0, 18)); 
    jRadioButton6.setText(bundle.getString("WSNNodesManager.jRadioButton6.text")); 
    jPanel11.add(jRadioButton6);
    jRadioButton6.setBounds(330, 370, 140, 30);

    jCheckBox5.setFont(new java.awt.Font("?s?????", 0, 14)); 
    jCheckBox5.setText(bundle.getString("WSNNodesManager.jCheckBox5.text")); 
    jPanel11.add(jCheckBox5);
    jCheckBox5.setBounds(210, 310, 230, 27);

    jLabel50.setFont(new java.awt.Font("?s?????", 0, 14)); 
    jLabel50.setText(bundle.getString("WSNNodesManager.jLabel50.text")); 
    jPanel11.add(jLabel50);
    jLabel50.setBounds(440, 310, 210, 30);

    jTextField16.setFont(new java.awt.Font("?s?????", 0, 14)); 
    jTextField16.setText(bundle.getString("WSNNodesManager.jTextField16.text")); 
    jTextField16.setToolTipText(bundle.getString("WSNNodesManager.jTextField16.toolTipText")); 
    jPanel11.add(jTextField16);
    jTextField16.setBounds(650, 310, 70, 30);

    jTabbedPane2.addTab(bundle.getString("WSNNodesManager.jPanel11.TabConstraints.tabTitle"), jPanel11); 

    jPanel10.add(jTabbedPane2, java.awt.BorderLayout.CENTER);

    jTabbedPane1.addTab(bundle.getString("WSNNodesManager.jPanel10.TabConstraints.tabTitle"), jPanel10); 
